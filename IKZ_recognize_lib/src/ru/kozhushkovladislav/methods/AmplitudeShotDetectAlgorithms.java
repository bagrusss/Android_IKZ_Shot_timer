...
import ru.kozhushkovladislav.audio.Sample;
import ru.kozhushkovladislav.audio.SampleBuffer;

public class AmplitudeShotDetectAlgorithms  implements IKZDetector.IKZDetectAlgorithms {

    float mThresholdLinear ;
    @Override
    public Long[] DetectIKZAlgorithms(SampleBuffer buffer, SampleBuffer prevBuffer) {
